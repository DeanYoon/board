...
cursor.execute('INSERT INTO posts (title, content, user_id, board_name, created_at, views, board_id) VALUES (?, ?, ?, ?, ?, ?, ?)',
               ('My First Post', 'This is the content of my first post.', 1, 'Programming', '2022-04-01 12:00:00', 10, 1))
cursor.execute('INSERT INTO posts (title, content, user_id, board_name, created_at, views, board_id) VALUES (?, ?, ?, ?, ?, ?, ?)',
               ('My Second Post', 'This is the content of my second post.', 2, 'Music', '2022-04-02 10:00:00', 5, 2))
